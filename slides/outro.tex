...
% 		$\rightsquigarrow$ \gold{too stubborn to see the quantitative (`linear') aspects}
% 		\item There are topoi $\Sh_\aetop W$ which mimick the Grothendieck topoi of schemes\\
% 		$\rightsquigarrow$ \gold{ how far does the analogy go?}
...
% 		$\rightsquigarrow$ \gold{TODO: go all the way to stochastic calculus}
% 	\end{enumerate}
% \end{frame}
